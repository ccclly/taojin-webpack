...
import { ReactComponent as ArrowLeft } from "../../../common/icon/arrow-left.svg";
import { ReactComponent as AddNote } from "../../../common/icon/add-note.svg";
import {
  initialUserData,
...
export default function Main() {
  ...
  const addSite = () => {
    ...
    content.siteOrigin = window.location.origin;
